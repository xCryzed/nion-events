...
const Administration = () => {
  ...
  useEffect(() => {
    document.title =
      "Administration - DJ Aachen & Eventtechnik | NION Events Mitarbeiterbereich";
  }, []);
  ...
  const fetchCounts = async () => {
    try {
      ...
      const { count: internalEventCount, error: internalEventError } =
        await supabase
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-muted-foreground">
                Qualifikationen und Anfragen verwalten
              </p>
            </div>
        ...
        return (
          <div className="space-y-6">
            <div>
              ...
              <p className="text-muted-foreground">
                Mitarbeiter-Einladungen verwalten
              </p>
            </div>
            <InvitationsTab />
          </div>
        ...
        return (
          <div className="space-y-6">
            <div>
              ...
              <p className="text-muted-foreground">
                Mitarbeiter-Personalakten verwalten
              </p>
            </div>
        ...
        return (
          <div className="space-y-6">
            <div>
              ...
              <p className="text-muted-foreground">
                Arbeitszeiten der Mitarbeiter verwalten
              </p>
            </div>
            <TimeRecordsTab />
          </div>
          ...
          <div className="space-y-6">
            ...
            <Card className="p-8">
              <div className="text-center">
                ...
                <p className="text-muted-foreground">
                  Erweiterte Sicherheitsfeatures werden hier konfiguriert.
                </p>
              </div>
            </Card>
          </div>
      ...
      <div className="flex items-center justify-center min-h-screen p-4">
        <Card className="max-w-md w-full">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Sie haben keine Berechtigung für die Administration. Wenden Sie
              sich an einen Administrator, um Zugriff zu erhalten.
            </CardDescription>
          </CardHeader>
        </Card>
      </div>
