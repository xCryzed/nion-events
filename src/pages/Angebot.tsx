...
const angebotSchema = z
  .object({
    veranstaltungstitel: z
      .string()
      .min(1, "Veranstaltungstitel ist erforderlich"),
    datum: z.date({ required_error: "Datum ist erforderlich" }),
    istMehrtaegig: z.boolean().default(false),
    enddatum: z.date().optional(),
    location: z.string().optional(),
    locationOption: z
      .enum(["has_location", "find_location"])
      .default("has_location"),
    ...
    veranstaltungstechnik: z
      .array(z.string())
      .min(1, "Mindestens eine Technik auswählen"),
    ...
    kontakt: z.object({
      ...
      telefon: z
        ...
        .regex(/^[\d\s\+\-\(\)\/]{8,}$/, "Gültige Telefonnummer erforderlich"),
      ...
      postleitzahl: z
        .string()
        .min(5, "Postleitzahl ist erforderlich")
        .max(5, "Postleitzahl muss 5 Stellen haben"),
...
const technikOptionen = [
  ...
  },
  {
    ...
    icon: Lightbulb,
    description:
      "Stimmungsvolle Beleuchtung und Effekte für Ihre Veranstaltung",
  },
  {
    id: "buehne",
    label: "Bühnentechnik",
...
const steps = [
  {
    id: 1,
    title: "Event Details",
    description: "Grundlegende Informationen zu Ihrer Veranstaltung",
  },
  {
    id: 2,
    title: "Technik & Service",
    description: "Gewünschte Technik und Dienstleistungen",
  },
  {
    id: 3,
    title: "Kontaktdaten",
    description: "Ihre Kontaktinformationen für das Angebot",
  },
];
...
const Angebot = () => {
  ...
  useEffect(() => {
    document.title =
      "Angebot anfordern - DJ Aachen & Eventtechnik | NION Events";
  }, []);
    ...
    if (currentStep < 3) {
      ...
      if (isCurrentStepValid) {
        ...
        toast({
          ...
          description:
            "Vervollständigen Sie die aktuellen Angaben, bevor Sie fortfahren.",
          variant: "destructive",
        });
      }
    }
  ...
  const getStepValidation = (step: number) => {
    ...
    if (step === 1) {
      const step1Fields = ["veranstaltungstitel", "datum", "gasteanzahl"];
      const hasBasicErrors = step1Fields.some(
        (field) => errors[field as keyof AngebotForm],
      );
      const locationOption = form.getValues("locationOption");
      const hasLocationError =
        locationOption === "has_location" && errors.location;
      ...
      return (
        ...
        !errors.kontakt?.telefon &&
        !errors.kontakt?.strasse &&
        !errors.kontakt?.hausnummer &&
        !errors.kontakt?.postleitzahl &&
        !errors.kontakt?.ort
      );
    }
  ...
  const onSubmit = async (data: AngebotForm) => {
    ...
    try {
      ...
      const eventRequestData = {
        ...
        end_date:
          data.istMehrtaegig && data.enddatum
            ? data.enddatum.toISOString()
            : null,
        location:
          data.locationOption === "has_location"
            ? data.location || ""
      ...
      console.log(
        "Event request saved successfully with offer number:",
        angebotsnummer,
      );
      ...
      try {
        ...
        const [notificationResult, confirmationResult] =
          await Promise.allSettled([
            ...
            supabase.functions.invoke("send-offer-confirmation", {
              body: emailData,
            }),
          ]);
        ...
        if (notificationResult.status === "rejected") {
          ...
          if (
            ...
            toast({
              ...
              description:
                "Sie haben zu viele Angebotsanfragen in kurzer Zeit gesendet. Bitte versuchen Sie es in einer Stunde erneut.",
              variant: "destructive",
            });
            return;
          }
        ...
        if (
          emailError?.message?.includes("Rate limit exceeded") ||
      ...
      trackError(
        error instanceof Error ? error : "Event request submission failed",
        "form_submission",
        "angebot_form",
        {
          event_title: data.veranstaltungstitel,
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              <h1 className="text-display mb-6">
                ...
                <span className="text-gradient">Anfrage!</span>
              </h1>
              <p className="text-body-large text-muted-foreground mb-8 max-w-2xl mx-auto">
                Wir haben Ihre Anfrage erhalten und werden Ihnen innerhalb von
                24 Stunden ein individuelles Angebot erstellen.
              </p>
            </div>
                ...
                <div className="text-center">
                  ...
                  <div className="w-full bg-border rounded-full h-2 mb-4">
                    <div
                      ...
                      style={{
                        width: `${((24 * 60 * 60 - timeLeft) / (24 * 60 * 60)) * 100}%`,
                      }}
                    ></div>
                  </div>
      ...
      <section className="py-20 relative overflow-hidden">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <h1 className="text-display mb-6">
              Ihr <span className="text-gradient">perfektes Event</span>
              <br />
              beginnt hier
            </h1>
            <p className="text-body-large text-muted-foreground max-w-2xl mx-auto">
              Beschreiben Sie uns Ihre Vorstellungen und erhalten Sie innerhalb
              von 24 Stunden ein maßgeschneidertes Angebot für Ihre
              Veranstaltung.
            </p>
          </div>
                    ...
                    <div className="space-y-6">
                      <div className="space-y-2">
                        ...
                        {form.formState.errors.veranstaltungstitel && (
                          <p className="text-sm text-destructive">
                            {form.formState.errors.veranstaltungstitel.message}
                          </p>
                        )}
                      </div>
                      ...
                      <div className="grid md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                          ...
                          {form.formState.errors.gasteanzahl && (
                            <p className="text-sm text-destructive">
                              {form.formState.errors.gasteanzahl.message}
                            </p>
                          )}
                        </div>
                          ...
                          <Controller
                            ...
                            render={({ field }) => (
                              ...
                              >
                                ...
                                <SelectContent>
                                  <SelectItem value="has_location">
                                    Ich habe bereits eine Location
                                  </SelectItem>
                                  <SelectItem value="find_location">
                                    Ich möchte eine passende Location finden
                                  </SelectItem>
                                </SelectContent>
                              </Select>
                            )}
                      ...
                      {form.watch("locationOption") === "find_location" && (
                        <div className="p-4 rounded-lg bg-muted/50 border border-border">
                          <p className="text-sm text-muted-foreground">
                            Gerne helfen wir Ihnen bei der Suche nach der
                            perfekten Location für Ihr Event. Weitere Details
                            können Sie in den Zusatzwünschen im nächsten Schritt
                            angeben.
                          </p>
                        </div>
                      )}
                ...
                {currentStep === 2 && (
                  <div className="space-y-10">
                    <div className="text-center mb-12">
                      ...
                      <p className="text-muted-foreground">
                        Wählen Sie die gewünschten Services für Ihr Event
                      </p>
                    </div>
                    ...
                    <div className="space-y-6">
                      <div className="flex items-center space-x-3 mb-6">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            Professionelle Musik für Ihr Event
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex flex-wrap gap-3">
                          {genreOptionen.map((genre) => {
                            const isSelected =
                              form.watch("djGenres")?.includes(genre) || false;
                    ...
                    <div className="space-y-6">
                      <div className="flex items-center space-x-3 mb-6">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            Professionelle Dokumentation und Beleuchtung
                          </p>
                        </div>
                      </div>
                        ...
                        {[
                          {
                            ...
                            icon: Camera,
                            label: "Fotograf",
                            desc: "Professionelle Event-Fotografie",
                          },
                          {
                            key: "videograf",
                            icon: Video,
                            label: "Videograf",
                            desc: "Hochwertige Videoproduktion",
                          },
                          {
                            key: "lichtoperator",
                            icon: Lightbulb,
                            label: "Licht Operator",
                            desc: "Professionelle Lichtführung",
                          },
                        ].map((service) => {
                          const isSelected =
                            form.watch(service.key as any) || false;
                    ...
                    <div className="space-y-6">
                      <div className="flex items-center space-x-3 mb-6">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            Professionelle Technik für Ihr Event
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                        {technikOptionen.map((technik) => {
                          const isSelected =
                            form
                              .watch("veranstaltungstechnik")
                              ?.includes(technik.id) || false;
                          ...
                          return (
                            <div
                              ...
                              onClick={() => {
                                const currentTechnik =
                                  form.getValues("veranstaltungstechnik") || [];
                                const newValue = isSelected
                                  ? currentTechnik.filter(
                                      (item) => item !== technik.id,
                                    )
                      ...
                      {form.formState.errors.veranstaltungstechnik && (
                        <p className="text-sm text-destructive">
                          {form.formState.errors.veranstaltungstechnik.message}
                        </p>
                      )}
                    </div>
                ...
                {currentStep === 3 && (
                  <div className="space-y-8">
                    <div className="text-center mb-8">
                      ...
                      <p className="text-muted-foreground">
                        Damit wir Ihnen das Angebot zusenden können
                      </p>
                    </div>
                      ...
                      <div className="grid md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            className="bg-input/50"
                          />
                          {form.formState.errors.kontakt?.name &&
                            form.formState.touchedFields.kontakt?.name && (
                              <p className="text-sm text-destructive">
                                {form.formState.errors.kontakt.name.message}
                              </p>
                            )}
                        </div>
                        ...
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            className="bg-input/50"
                          />
                          {form.formState.errors.kontakt?.email &&
                            form.formState.touchedFields.kontakt?.email && (
                              <p className="text-sm text-destructive">
                                {form.formState.errors.kontakt.email.message}
                              </p>
                            )}
                        </div>
                        ...
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            className="bg-input/50"
                          />
                          {form.formState.errors.kontakt?.telefon &&
                            form.formState.touchedFields.kontakt?.telefon && (
                              <p className="text-sm text-destructive">
                                {form.formState.errors.kontakt.telefon.message}
                              </p>
                            )}
                        </div>
                        ...
                        <div className="grid md:grid-cols-3 gap-4">
                          <div className="space-y-2 md:col-span-2">
                            ...
                            <Input
                              ...
                              className="bg-input/50"
                            />
                            {form.formState.errors.kontakt?.strasse &&
                              form.formState.touchedFields.kontakt?.strasse && (
                                <p className="text-sm text-destructive">
                                  {
                                    form.formState.errors.kontakt.strasse
                                      .message
                          ...
                          <div className="space-y-2">
                            ...
                            <Input
                              ...
                              className="bg-input/50"
                            />
                            {form.formState.errors.kontakt?.hausnummer &&
                              form.formState.touchedFields.kontakt
                                ?.hausnummer && (
                                <p className="text-sm text-destructive">
                                  {
                                    form.formState.errors.kontakt.hausnummer
                        ...
                        <div className="grid md:grid-cols-2 gap-4">
                          <div className="space-y-2">
                            ...
                            <Input
                              ...
                              maxLength={5}
                            />
                            {form.formState.errors.kontakt?.postleitzahl &&
                              form.formState.touchedFields.kontakt
                                ?.postleitzahl && (
                                <p className="text-sm text-destructive">
                                  {
                          ...
                          <div className="space-y-2">
                            ...
                            <Input
                              ...
                              className="bg-input/50"
                            />
                            {form.formState.errors.kontakt?.ort &&
                              form.formState.touchedFields.kontakt?.ort && (
                                <p className="text-sm text-destructive">
                                  {form.formState.errors.kontakt.ort.message}
                                </p>
                              )}
                          </div>
                        </div>
                    ...
                    <Button
                      ...
                      onClick={() => {
                        trackEvent(
                          "click",
                          "engagement",
                          `angebot_step_${currentStep}_next`,
                        );
                        nextStep();
                      }}
                      className="btn-hero"
