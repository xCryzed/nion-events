...
const Presse = () => {
  ...
  const artists = {
    NION: {
      ...
      description:
        "NION ist ein innovativer Electronic Music Producer, der für seine atmosphärischen Soundscapes und energiegeladenen Live-Performances bekannt ist. Seine Musik vereint Progressive House mit cineastischen Elementen.",
      image: nionPortrait,
      liveImage: nionLive,
      stats: {
        tracks: "50+",
    ...
    DEE: {
      ...
      description:
        "DEE bringt mit ihrem unverwechselbaren Tech House Sound die Clubs zum Kochen. Ihre Sets sind eine perfekte Mischung aus hypnotischen Rhythmen und kraftvollen Basslines.",
      image: deePortrait,
      liveImage: deeLive,
      stats: {
        tracks: "35+",
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Pressmaterial, Bilder und Informationen zu unseren Artists für
              Medien und Veranstalter.
            </p>
          </div>
                ...
                <div className="relative aspect-video overflow-hidden">
                  ...
                  <div className="absolute bottom-6 left-6 right-6 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <h3 className="text-xl font-bold text-white mb-2">
                      {currentArtist.name} Live
                    </h3>
                    <p className="text-white/80">
                      High-resolution performance photography • 1920x1080
                    </p>
                  </div>
                </div>
              </div>
