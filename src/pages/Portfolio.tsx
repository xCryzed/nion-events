          ...
          <div className="text-center mt-16">
            <div className="glass-card p-8 rounded-2xl max-w-2xl mx-auto">
              ...
              <p className="text-muted-foreground mb-6">
                Lassen Sie uns gemeinsam Ihr nächstes unvergessliches Event
                planen. Kontaktieren Sie uns für ein unverbindliches
                Beratungsgespräch.
              </p>
              <a
                href="#contact"
                ...
                onClick={() =>
                  trackEvent("click", "conversion", "portfolio_contact_cta")
                }
              >
