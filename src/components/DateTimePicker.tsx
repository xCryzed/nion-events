    ...
    <div className="space-y-3">
      ...
      <div className="flex flex-col gap-2">
          ...
          <Popover>
            <PopoverTrigger asChild>
              ...
              >
                ...
                {dateTime ? format(dateTime, 'dd.MM.yyyy', { locale: de }) : 'Datum wählen'}
              </Button>
            </PopoverTrigger>
            <PopoverContent className="w-auto p-0 bg-background border z-50" align="start">
              <div className="p-3 border-b bg-muted/50">
                <p className="text-sm font-medium text-center">
                  {dateTime ? format(dateTime, 'MMMM yyyy', { locale: de }) : format(new Date(), 'MMMM yyyy', { locale: de })}
                </p>
              </div>
              <Calendar
                mode="single"
                ...
                disabled={(date) => {
                  ...
                  return (minDateOnly && dateOnly < minDateOnly) ||
        ...
        <div className="flex items-center gap-2 h-10 justify-start">
          <Select value={timeString.split(':')[0] || ''} onValueChange={handleHourChange} disabled={disabled || !dateTime}>
          ...
          <Select value={timeString.split(':')[1] || ''} onValueChange={handleMinuteChange} disabled={disabled || !dateTime}>
            <SelectTrigger className="w-20 h-10">
