...
const FAQ = () => {
  ...
  const faqData: FAQItem[] = [
    // Einstieg & Leistungen
    {
      ...
      question:
        "Wie läuft die Zusammenarbeit mit NION Events konkret ab – von der ersten Anfrage bis zum Event?",
      answer:
    ...
    },
    {
      ...
      question:
        "Welche Eventformate realisieren Sie neben Hochzeiten und Firmenfeiern?",
      answer:
    ...
    },
    {
      ...
      icon: <Music className="w-4 h-4" />,
      question:
        "Können Musikwünsche im Vorfeld und live berücksichtigt werden?",
      answer:
      ...
      <div className="container relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            ...
            Services, Preise und Abläufe. Nutzen Sie die Suchfunktion für
            gezielte Ergebnisse.
          </p>
        </div>
        ...
        <div className="max-w-2xl mx-auto mb-12">
          <div className="relative">
            <Search className="absolute left-4 top-1/2 transform -translate-y-1/2 text-primary w-6 h-6 z-10 drop-shadow-sm" />
            <Input
              type="text"
          ...
          {searchTerm && (
            <p className="text-center mt-4 text-muted-foreground">
              {filteredFAQs.length} Ergebnis
              {filteredFAQs.length !== 1 ? "se" : ""} gefunden
            </p>
          )}
        </div>
        ...
        {filteredFAQs.length === 0 && searchTerm && (
          <div className="text-center py-16">
            ...
            <p className="text-muted-foreground mb-6 max-w-md mx-auto">
              Ihre Suche nach "{searchTerm}" ergab keine Treffer. Versuchen Sie
              andere Suchbegriffe oder kontaktieren Sie uns direkt.
            </p>
        ...
        <div className="text-center mt-16 glass-card p-8 rounded-3xl bg-gradient-to-br from-primary/5 to-accent/5 border-primary/20">
          ...
          <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
            Kein Problem! Kontaktieren Sie uns gerne direkt. Wir beraten Sie
            kostenlos und unverbindlich zu allen Aspekten Ihres Events.
          </p>
          <a href="#contact">
