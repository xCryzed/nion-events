...
const PersonnelTab = () => {
  ...
  const fetchEmployees = async () => {
    try {
      ...
      const employeesWithData: Employee[] =
  ...
  const handleDownloadPDF = async (employee: Employee) => {
    if (!employee.personal_data || !employee.personal_data.is_complete) {
      toast({
        title: "Keine Daten",
        description:
          "Für diesen Mitarbeiter sind keine vollständigen Personaldaten verfügbar.",
        variant: "destructive",
      });
      return;
    }
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {
                employees.filter(
                  (e) => e.personal_data && !e.personal_data.is_complete,
                ).length
              }
            </div>
          </CardContent>
                    ...
                    <TableRow key={employee.user_id}>
                      ...
                      <TableCell>
                        <div className="flex flex-wrap gap-1">
                          {employeeQualifications[employee.user_id]?.length >
                          0 ? (
                            employeeQualifications[employee.user_id].map(
                              (qual, index) => (
                                <Badge
                                  key={index}
                                  variant="secondary"
                          ...
                          >
                            <DialogTrigger asChild>
                              <Button
                                ...
                                size="sm"
                                onClick={() =>
                                  handleViewPersonnelFile(employee)
                                }
                            ...
                            <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
                              <DialogHeader>
                                <DialogTitle>
                                  Personalakte - {employee.first_name}{" "}
                                  {employee.last_name}
                                </DialogTitle>
                                <DialogDescription>
                                ...
                                <PersonalDataCard
                                  ...
                                  onEdit={() => {
                                    ...
                                    toast({
                                      title: "Info",
                                      description:
                                        "Bearbeitung über die Mitarbeiter-Ansicht möglich.",
                                    });
                                  }}
                                />
                              )}
