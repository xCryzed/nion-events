...
import { Plus, Pencil, Trash2, Calendar, Euro, Award, Users, X, Eye, UserCheck, FileText } from 'lucide-react';
...
const EnhancedEventsTab = () => {
  ...
  const [availableCategories] = useState([
    'DJ', 'Lichttechnik', 'Tontechnik', 'Security', 'Thekenkraft', 
    'Auf-/Abbau', 'Transport', 'Koordination'
  ]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const eventData = {
        ...
        pricing_structure: JSON.stringify(staffRequirements.map(req => ({
          category: req.category,
          type: req.hourlyRate ? 'hourly' : 'flat',
          amount: req.hourlyRate || req.flatRate || 0
        }))),
        qualification_requirements: JSON.stringify(staffRequirements.map(req => ({
          category: req.category,
  ...
  const addStaffRequirement = () => {
    setStaffRequirements([...staffRequirements, {
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">
            Erstelle und verwalte interne Events mit Personalanforderungen und Arbeitsverträgen
          </p>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => setFormData({ ...formData, contract_required: !!checked })}
                />
              ...
              <div>
                <div className="flex justify-between items-center mb-4">
                  <h3 className="text-lg font-semibold">Personalanforderungen</h3>
                      ...
                      <div className="grid grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                          ...
                          <Input
                            ...
                            min="1"
                            value={req.count}
                            onChange={(e) => updateStaffRequirement(index, 'count', parseInt(e.target.value))}
                          />
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-4 mb-4">
                        <div>
                          ...
                          <Input
                            ...
                            onChange={(e) => updateStaffRequirement(index, 'hourlyRate', parseFloat(e.target.value) || undefined)}
                        ...
                        <div>
                          ...
                          <Input
                            ...
                            step="0.01"
                            value={req.flatRate || ''}
                            onChange={(e) => updateStaffRequirement(index, 'flatRate', parseFloat(e.target.value) || undefined)}
                      ...
                      <div className="mb-4">
                        <label className="flex items-center text-sm">
                          <input
                            ...
                            onChange={(e) => updateStaffRequirement(index, 'requires_contract', e.target.checked)}
                            className="mr-2"
                          />
            ...
            <TableBody>
              {events.map((event) => (
                <TableRow key={event.id}>
                    ...
                    <div className="text-sm">
                      ...
                      {event.end_date && (
                        <div className="text-muted-foreground">
                          bis {format(new Date(event.end_date), 'dd.MM.yyyy HH:mm', { locale: de })}
                        </div>
                      )}
                    </div>
                  </TableCell>
                  ...
                  <TableCell>
                    <Badge variant={
                      event.status === 'aktiv' ? 'default' :
                      event.status === 'abgeschlossen' ? 'secondary' :
                      event.status === 'abgesagt' ? 'destructive' : 'outline'
                    }>
                      {event.status}
                    </Badge>
                  </TableCell>
