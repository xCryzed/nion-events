...
const QualificationsTab = () => {
      ...
      if (editingQualification) {
        const { error } = await supabase
          ...
          .update({
            ...
            validity_period_months:
              formData.is_expirable && formData.validity_period_months
  ...
  const handleEdit = (qualification: Qualification) => {
    ...
    setFormData({
      ...
      validity_period_months:
        qualification.validity_period_months?.toString() || "",
    });
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">
            Verwalten Sie die verfügbaren Qualifikationen für Mitarbeiter und
            Jobs
          </p>
        </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      Erfordert diese Qualifikation einen Nachweis?
                    </p>
                  </div>
                  <Switch
                    checked={formData.requires_proof}
                    onCheckedChange={(checked) =>
                      setFormData({ ...formData, requires_proof: checked })
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      Hat diese Qualifikation ein Ablaufdatum?
                    </p>
                  </div>
                  <Switch
                    checked={formData.is_expirable}
                    onCheckedChange={(checked) =>
                      setFormData({ ...formData, is_expirable: checked })
                    }
                  />
                </div>
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                          validity_period_months: e.target.value,
                        })
                      }
                      placeholder="z.B. 12"
                      min="1"
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {qualifications.length} Qualifikation
            {qualifications.length !== 1 ? "en" : ""} verfügbar
          </CardDescription>
        </CardHeader>
        <CardContent>
          {qualifications.length === 0 ? (
            <div className="text-center py-8">
              ...
              <p className="text-muted-foreground">
                Noch keine Qualifikationen erstellt
              </p>
            </div>
          ) : (
            <Table>
