...
const EventRequestsTable = () => {
  ...
  const fetchEventRequests = async () => {
    try {
      ...
      console.error("Error fetching event requests:", error);
      trackError(
        error instanceof Error ? error : "Event requests fetch failed",
        "data_fetch",
        "event_requests_table",
      );
    } finally {
      setLoading(false);
    }
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-6">
            ...
            <Select value={statusFilter} onValueChange={setStatusFilter}>
              ...
              <SelectContent className="bg-popover border shadow-lg z-50">
                ...
                <SelectItem value="RÜCKFRAGEN_OFFEN">
                  Rückfragen offen
                </SelectItem>
                      ...
                      <div className="flex items-start justify-between gap-3">
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            <span
                              className={`px-2 py-0.5 rounded-full text-xs font-medium border flex items-center gap-1 ${getStatusColor(request.status)}`}
                            >
