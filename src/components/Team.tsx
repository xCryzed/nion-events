...
const Team = () => {
  const teamMembers: TeamMember[] = [
    {
      ...
      position: "CEO & DJ",
      description:
        "Kreiert Mashups und einzigartige Song-Variationen, die Klassiker neu erfinden und die Crowd überraschen.",
    ...
    },
    {
      ...
      description:
        "Setzt den Standard für Hip-Hop-DJing – energiegeladen, präzise und mit tiefem Gespür für die Kultur.",
    ...
    },
    {
      ...
      position: "DJ Specialist",
      description:
        "Vereint authentischen Hip-Hop mit pulsierenden Latin-Rhythmen – stilistisch sicher und musikalisch grenzenlos.",
    ...
    },
    {
      ...
      position: "DJ Specialist",
      description:
        "Bringt höchste technische Finesse und musikalische Vielseitigkeit mit – ein DJ, der jedes Publikum punktgenau abholt.",
    ...
    },
    {
      ...
      description:
        "Setzt die größten Festivals Deutschlands mit seinen Aftermovies atmosphärisch und stilbewusst in Szene.",
    ...
    },
    {
      ...
      description:
        "Technikprofi mit umfassendem Know-how und jahrelanger Erfahrung für perfekte Bühnen- und Veranstaltungstechnik.",
    ...
    },
    {
      ...
      position: "Technical Expert",
      description:
        "Sorgt mit präziser Licht- und Tontechnik für ein beeindruckendes Event-Ambiente und unvergessliche Momente.",
      badges: ["Lighting Expert", "Sound Engineer"],
      icon: <Wrench className="w-6 h-6" />,
      image: devin,
    },
    {
      ...
      position: "Technical Expert",
      description:
        "Von der ersten Verkabelung bis zum letzten Feinschliff – er liefert Technik, die beeindruckt und funktioniert.",
      badges: ["Lighting Expert", "Sound Engineer"],
      icon: <Wrench className="w-6 h-6" />,
      image: robin,
    },
  ...
  const getBadgeVariant = (badge: string) => {
    const variants: Record<string, string> = {
      ...
      "Content Creator":
        "bg-gradient-to-r from-red-600 to-rose-600 text-white border-none",
      "Hip-Hop DJ":
        "bg-gradient-to-r from-green-600 to-emerald-600 text-white border-none",
      Videographer:
        "bg-gradient-to-r from-indigo-600 to-purple-600 text-white border-none",
      "Sound Engineer":
        "bg-gradient-to-r from-slate-600 to-zinc-600 text-white border-none",
      "Lighting Expert":
        "bg-gradient-to-r from-amber-600 to-yellow-600 text-white border-none",
      "Visual Artist":
        "bg-gradient-to-r from-pink-600 to-rose-600 text-white border-none",
    };
  ...
  return (
    <section id="team" className="section-padding relative overflow-hidden">
      ...
      <div
        className="absolute top-3/4 right-1/4 w-1 h-1 bg-accent/40 rounded-full animate-pulse"
        style={{ animationDelay: "1s" }}
      ></div>
      <div
        className="absolute top-1/2 left-1/6 w-1.5 h-1.5 bg-primary/20 rounded-full animate-pulse"
      ...
      <div className="container relative z-10">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-body-large text-muted-foreground max-w-3xl mx-auto">
            Lernen Sie das kreative Powerhouse hinter NION Events kennen. Jeder
            bringt einzigartige Talente und Leidenschaft mit, um Ihre Vision zum
            Leben zu erwecken.
          </p>
        </div>
        ...
        >
          <div className="glass-card p-8 max-w-2xl mx-auto">
            ...
            <p className="text-muted-foreground mb-6">
              Unser erfahrenes Team steht bereit, um Ihre Vision in die Realität
              umzusetzen.
            </p>
            <a href="#contact">
              <button className="btn-hero">Jetzt kontaktieren</button>
            </a>
          </div>
        </div>
      </div>
