...
export const PersonalDataCard: React.FC<PersonalDataCardProps> = ({
  ...
  const copyPersonnelNumber = async () => {
    try {
      ...
      toast({
        title: "Kopiert",
        description: "Personalnummer wurde in die Zwischenablage kopiert.",
      });
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <p className="text-base flex flex-col sm:flex-row sm:items-center gap-2 text-white">
                    ...
                    <span>
                      {(() => {
                        const s = data.date_of_birth as any;
                        const d =
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="text-base flex flex-col sm:flex-row sm:items-center gap-2 text-white">
                    ...
                    <span>
                      {(() => {
                        const s = data.start_date as any;
                        const d =
                          typeof s === "string" ? parseISO(s) : new Date(s);
                        return isValid(d) ? format(d, "dd.MM.yyyy") : String(s);
                      })()}
        ...
        {data.has_additional_employment &&
          ...
          data.other_employment_details.length > 0 && (
            <Card className="glass-card bg-white/5 border-white/10 text-white">
              ...
              <CardContent className="space-y-4">
                {data.other_employment_details.map(
            ...
            <CardContent className="space-y-4">
              ...
              {data.signature_date && (
                <p className="text-sm text-white/60">
                  Unterschrieben am:{" "}
                  {format(new Date(data.signature_date), "dd.MM.yyyy", {
                    locale: de,
                  })}
                </p>
              )}
