        ...
        <div className="container">
          ...
          <div className="relative py-20">
            ...
            <div className="relative overflow-hidden py-12">
              {/* Mobile: Static grid view for better compatibility */}
                  ...
                  {partners.slice(0, 6).map((partner, index) => (
                      ...
                      >
                        <a
                            ...
                            className="block"
                        >
                          <div className="w-full h-32 flex items-center justify-center p-4 rounded-xl bg-background/50 border border-border/30 hover:border-primary/50 transition-all duration-500 hover:bg-background/80 group-hover:scale-105 hover:shadow-lg hover:shadow-primary/20">
                            <img
                                src={partner.logo}
                          ...
                          <p className="text-center mt-3 text-xs font-medium text-muted-foreground group-hover:text-foreground transition-colors">
                            {partner.name}
                          </p>
                        </a>
                      </div>
              ...
              {/* Desktop: Scrolling animation with improved browser compatibility */}
