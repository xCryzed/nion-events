...
const Testimonials = () => {
  ...
  const events = [
    ...
    },
    {
      ...
      description:
        "Bei diesem außergewöhnlichen Sommerfest verwandelte unser Team die Halle 60 in eine eindrucksvolle Festival-Location. Unter dem Motto Von Aachen aus in die ganze Welt feierten Mitarbeiter:innen und Gäste die internationale Bedeutung der innovativen Herzpumpen. Wir verantworteten die komplette technische Betreuung, die DJ-Planung, die Gestaltung einer Geländeübersicht sowie den professionellen Auf- und Abbau und stellten so einen reibungslosen Ablauf sicher. Dieses Recap-Video zeigt die Highlights eines unvergesslichen Tages.",
      date: "August 2024",
      attendees: "600+",
  ...
  const testimonials = [
    {
      name: "Nele Frohn",
      content:
        "Einfach 5/5, denn besser geht es kaum. Unkomplizierte Kommunikation vor der Party und nette gemeinsame Planung. Auch der Auf- und Abbau klappt super. Um halb zehn ging’s los auf der Tanzfläche und bis drei Uhr wurde durch getanzt. Alle Gäste inklusive mir sind und waren begeistert. Tausend Dank, immer wieder würde ich euch buchen 🫶🏻",
      rating: 5,
    },
    {
      name: "Jörg Schreiber",
      content:
        "Nino hat den 18. Geburtstag unserer Tochter zu einem unvergesslichen Event werden lassen. Alle waren total begeistert und wir haben bis in die frühen Morgenstunden durchgetanzt. Einfach mega. Vielen lieben Dank, Nino.",
      rating: 5,
    },
    {
      name: "Silvia K",
      content:
        "Sehr nett und organisiert. Planung ohne Probleme und preis Leistungsverhältnis ist super. Der Abend war mega, die Musik hat perfekt gestimmt! Kann ich nur weiterempfehlen.",
      rating: 5,
    },
  ];
  ...
  const partners = [
    {
      ...
      logo: abiomed,
      website: "https://www.abiomed.com/de-de",
    },
    { name: "Johnson & Johnson", logo: jnj, website: "https://www.jnj.com" },
    {
      name: "Hammer GmbH & Co. KG",
      logo: hammer,
      website: "https://www.hammer-ac.de/",
    },
    { name: "NOX Aachen", logo: nox, website: "https://www.nox.ac/" },
    {
      name: "Apollo Aachen",
      logo: apollo,
      website: "https://apollo-aachen.de/",
    },
    {
      name: "Diskothek Himmerich",
      logo: himmerich,
      website: "https://www.himmerich.de",
    },
    {
      name: "DAS LIEBIG",
      logo: dasLiebig,
      website: "https://www.dasliebig.de",
    },
    {
      name: "JOY event & media GmbH & Co. KG",
      logo: joy,
      website: "https://www.joy-event-media.de/",
    },
    {
      name: "Rent2Night Eventmanagement",
      logo: rent2night,
      website: "https://rent2night.de/",
    },
    { name: "RELAY GmbH", logo: relay, website: "https://relay-on.de/" },
    {
      name: "RaneK Veranstaltungstechnik",
      logo: ranek,
      website: "https://www.instagram.com/rane_k_veranstaltungstechnik/",
    },
  ...
  const partnersToShow =
    shuffledPartners.length > 0 ? shuffledPartners : partners;
  ...
  return (
    <section id="testimonials" className="section-padding">
      <div className="container">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-body-large text-muted-foreground">
            Überzeugen Sie sich selbst von der Qualität unserer Arbeit. Hier
            sind einige Stimmen unserer zufriedenen Kunden.
          </p>
        </div>
          ...
          <div className="glass-card p-8 text-center bg-gradient-to-br from-primary/5 to-accent/5 border-primary/20">
            ...
            <div className="flex justify-center mb-4">
              {[...Array(5)].map((_, i) => (
                <svg
                  key={i}
                  className="w-6 h-6 text-accent mx-1"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                >
            ...
            <p className="text-muted-foreground mb-6">
              Ihre Meinung ist uns wichtig. Teilen Sie Ihre Erfahrung mit
              anderen und helfen Sie uns dabei, noch bessere Events zu
              gestalten.
            </p>

            <Button
              onClick={() =>
                window.open("https://g.page/r/CWnFptITqQNDEAE/review", "_blank")
              }
        ...
        <div className="relative py-20">
          <div className="text-center mb-16">
            <h3 className="text-4xl font-bold mb-6 text-foreground">
              Vertrauen von{" "}
              <span className="text-gradient">führenden Unternehmen</span>
            </h3>
            <div className="w-24 h-1 bg-gradient-primary rounded-full mx-auto mb-8"></div>
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Diese renommierten Unternehmen setzen auf unsere Expertise für
              ihre wichtigsten Events
            </p>
          </div>
      ...
      <div
        id="event-portfolio"
        className="relative py-16 sm:py-24 mt-20 w-full"
      >
        {/* Background Elements */}
        ...
        <div className="relative z-10 container">
          <div className="text-center mb-20">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Erleben Sie unsere erfolgreichsten Events und lassen Sie sich von
              der Qualität unserer Arbeit überzeugen. Jedes Event ist
              einzigartig und perfekt auf unsere Kunden abgestimmt.
            </p>
          </div>
