  ...
  const services = [
    {
      ...
      description:
        "Professioneller DJ-Service für jeden Anlass – von Club bis Gala",
      features: [
        "Individuelle Musikauswahl nach Kundenwunsch",
        "Moderation & Animation auf Wunsch",
        "DJ + Live-Musiker kombinierbar",
      ],
    },
    {
      icon: Volume2,
      ...
      features: [
        "Modernes Equipment & Bühnentechnik",
        "Auf- & Abbau durch erfahrene Techniker",
    ...
    },
    {
      ...
      description:
        "Individuelle Eventkonzeption: von der Idee bis zur Umsetzung",
      features: [
        "Ablaufplanung & Timemanagement",
        "Locationberatung & -scouting",
        "Moodboards & Konzepte",
      ],
    },
    {
      ...
      features: [
        "Geburtstagsfeiern (18., 30., 50., ...)",
        "Hochzeiten & Verlobungsfeiern",
        "Abibälle & Abschlussfeiern",
      ],
    },
    {
      icon: Briefcase,
      ...
      features: [
        ...
        "Produktpräsentationen & Markeninszenierungen",
    ...
    },
    {
      ...
      features: [
        "Silent-Disco (Kopfhörerpartys)",
        "Open-Air-Events & Pop-up-Veranstaltungen",
        "Hybrid-Events & Streaming-Technik",
      ],
    },
    {
      icon: Camera,
      ...
      features: [
        "Hochzeitsfotografie & -videos in Kino-Qualität",
        "Dynamische Aftermovies für Events",
    ...
    },
    {
      ...
      description:
        "Professionelle Transportlösungen für Events aller Größenordnungen",
      features: [
        "Flughafen-, Hotel- & Eventtransfer",
        "Limousinen, Vans, Sprinter & Busse verfügbar",
        "Koordinatoren vor Ort für reibungslosen Ablauf",
      ],
    },
    {
      icon: Package,
      ...
      description:
        "Alles aus einer Hand oder einzeln buchbar nach Ihren Bedürfnissen",
      features: [
        "Musik, Technik, Planung, Durchführung",
        "Einzeln buchbar: DJ, Technik oder Planung",
