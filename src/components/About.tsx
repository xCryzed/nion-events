  ...
  const values = [
    {
      ...
      title: "Leidenschaft",
      description:
        "Jedes Event wird mit persönlicher Hingabe und Liebe zum Detail geplant",
    },
    {
      icon: Award,
      title: "Qualität",
      description:
        "Höchste Standards in Planung, Durchführung und Kundenservice",
    },
    {
      icon: Users,
      title: "Vertrauen",
      description:
        "Langfristige Partnerschaften durch Zuverlässigkeit und Professionalität",
    },
    {
      icon: Zap,
      title: "Innovation",
      description:
        "Moderne Technologien und kreative Lösungen für unvergessliche Erlebnisse",
    },
  ];
        ...
        <div className="text-center mb-20">
          <div className="inline-flex items-center space-x-2 bg-card/50 backdrop-blur-sm px-6 py-3 rounded-full border border-border mb-6">
            ...
            <span className="text-sm text-muted-foreground font-medium tracking-wide">
              DJ- & EVENTMANAGEMENT MIT LEIDENSCHAFT UND SYSTEM
            </span>
          </div>
          <h2 className="text-5xl lg:text-6xl font-bold mb-6">
            <span className="text-foreground">NION </span>
            <span className="text-gradient">Events</span>
          </h2>
          <div className="w-24 h-1 bg-gradient-primary rounded-full mx-auto mb-8"></div>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Als DJ und Eventmanager aus Aachen bringe ich über 6 Jahre Erfahrung
            auf die Bühne – von Clubnächten bis zu Großveranstaltungen mit über
            2.500 Gästen.
          </p>
        </div>
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="space-y-6">
                <p className="text-lg leading-relaxed text-muted-foreground">
                  Seit 2019 stehe ich selbst als DJ hinter den Decks und habe
                  dabei nicht nur in fast jedem Club der Region aufgelegt,
                  sondern auch internationale Bookings, Hochzeiten, Abibälle und
                  Firmenevents erfolgreich begleitet.
                </p>

                <p className="leading-relaxed text-muted-foreground">
                  Im Oktober 2022 erfüllte ich mir einen langjährigen Traum:
                  meine eigene Veranstaltungsreihe DREAMBEATS – mit dem klaren
                  Ziel, elektronische Musik endlich wieder sichtbarer in Aachens
                  Eventlandschaft zu verankern. In einer Stadt, in der
                  elektronische Formate lange unterrepräsentiert waren, schuf
                  DREAMBEATS eine neue Plattform für moderne Clubkultur. Die
                  ersten Events fanden im Apollo und später im NOX Aachen statt
                  und trafen schnell auf eine wachsende Community. Nur ein Jahr
                  später folgte das nächste Level: Mit der DREAMBEATS LAB
                  veranstaltete ich an Halloween 2023 die größte Halloween-Party
                  Aachens – im DAS LIEBIG (ehemals Starfish Aachen). Die
                  Veranstaltung war ein voller Erfolg und hat eindrucksvoll
                  gezeigt, welches Potenzial elektronische Events in Aachen
                  haben – sowohl kulturell als auch organisatorisch.
                </p>

                <p className="leading-relaxed text-muted-foreground">
                  Im folgt die nächste Stufe: Aachens größte Beachparty mit über
                  2.500 Gästen, erneut im DAS LIEBIG.
                </p>

                <p className="leading-relaxed text-muted-foreground">
                  Mit der Gründung von NION Events habe ich meine Leidenschaft
                  zum Beruf gemacht. Heute betreue ich auch namhafte Kunden wie
                  Johnson & Johnson (ehemals Abiomed) und der Hammer GmbH & Co.
                  KG bei der professionellen Umsetzung ihrer Events.
                </p>

                <p className="leading-relaxed text-muted-foreground">
                  Dank meiner parallelen Laufbahn als Softwareentwickler biete
                  ich zusätzlich technische Lösungen auf höchstem Niveau – von
                  digitalen Tools bis zu individuellen Sonderwünschen. Durch
                  mein starkes Netzwerk in Aachen lassen sich nahezu alle Ideen
                  zuverlässig umsetzen – ob privat, geschäftlich oder
                  öffentlich.
                </p>
                ...
                <div className="relative group bg-gradient-to-r from-primary/10 to-accent/10 rounded-2xl p-6 border border-primary/20 hover:border-primary/40 transition-all duration-300">
                  ...
                  <h4 className="text-lg font-semibold text-primary mb-3">
                    DREAMBEATS in den Medien
                  </h4>
                  <p className="text-muted-foreground mb-4">
                    Die Aachener Zeitung berichtete über die Erfolgsgeschichte
                    von DREAMBEATS und die Entwicklung der elektronischen
                    Musikszene in Aachen.
                  </p>
                  <a
                ...
                <div className="text-center space-y-8">
                  ...
                  <div className="space-y-4 text-lg leading-relaxed max-w-3xl mx-auto">
                    <p className="text-foreground">
                      Maßgeschneiderte Eventlösungen – von stilvollen
                      Hochzeitsfeiern bis hin zu großen Firmenevents. Durch
                      meine umfassende Erfahrung garantiere ich Ihnen eine
                      professionelle Umsetzung auf höchstem Niveau.
                    </p>
                  </div>
