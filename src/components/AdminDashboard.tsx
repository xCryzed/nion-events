        ...
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-6 gap-4">
                ...
                <Card className="glass-card hover-lift">
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold text-gradient">{stats.totalEventRequests}</div>
                        <p className="text-xs text-muted-foreground">
                            Event-Anfragen
                        </p>
                    </CardContent>
                ...
                <Card className="glass-card hover-lift">
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                        <CardTitle className="text-sm font-medium">Veranstaltungen</CardTitle>
                        <Calendar className="h-4 w-4 text-primary" />
                    </CardHeader>
                    <CardContent>
                        <div className="text-2xl font-bold text-gradient">{stats.totalInternalEvents}</div>
                        <p className="text-xs text-muted-foreground">
                            Geplante Events
                        </p>
                    </CardContent>
                ...
                <Card className="glass-card hover-lift">
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold text-gradient">{stats.totalEventRegistrations}</div>
                        <p className="text-xs text-muted-foreground">
                            Event-Anmeldungen
                        </p>
                    </CardContent>
                ...
                <Card className="glass-card hover-lift">
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold text-gradient">{stats.upcomingEvents}</div>
                        <p className="text-xs text-muted-foreground">
                            Nächste 30 Tage
                        </p>
                    </CardContent>
                    ...
                    <CardContent className="space-y-4">
                        {stats.recentEventRequests.length === 0 ? (
                            ...
                            stats.recentEventRequests.map((eventRequest) => (
                                <div key={eventRequest.id} className="flex items-center justify-between p-3 rounded-lg border bg-card/50">
                                    <div className="flex-1">
                                        <div className="flex items-center gap-3">
                                            <div className="h-8 w-8 rounded-full bg-primary/10 flex items-center justify-center">
                                                <Calendar className="h-4 w-4 text-primary" />
                                            ...
                                            <div>
                                                <p className="font-medium text-sm">{eventRequest.event_title}</p>
                                                <p className="text-xs text-muted-foreground">{eventRequest.contact_name}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="text-right">
                                        ...
                                        <p className="text-xs text-muted-foreground">
                                            {formatDistanceToNow(new Date(eventRequest.created_at), { addSuffix: true, locale: de })}
                                        </p>
                                    </div>
                                </div>
                            ))
