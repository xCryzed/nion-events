  ...
  const onSubmit = async (values: FormData) => {
    ...
    try {
      ...
      try {
        ...
        const internalEmailResult = await supabase.functions.invoke(
        ...
        if (
          internalEmailResult.error?.message?.includes("Rate limit exceeded") ||
          ...
          toast({
            ...
            description:
              "Ihre Anfrage wurde gespeichert, aber zu viele Anfragen wurden kürzlich gesendet. Wir melden uns trotzdem bei Ihnen.",
            variant: "default",
          });
          return;
        }
        ...
        const customerEmailPromise = await supabase.functions.invoke(
        ...
        if (
          ...
          toast({
            ...
            description:
              "Sie haben zu viele Anfragen in kurzer Zeit gesendet. Bitte versuchen Sie es in einer Stunde erneut.",
            variant: "destructive",
          });
          return;
        }
      ...
      console.error("Error submitting contact request:", error);
      trackError(
        error instanceof Error ? error : "Contact form submission failed",
        "form_submission",
        "contact_form",
        {
          form_data: {
      ...
      <div className="container">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-headline mb-6">
            <span className="text-foreground">Lassen Sie uns </span>
          ...
          <p className="text-body-large text-muted-foreground">
            ...
            kostenlose Erstberatung und lassen Sie uns gemeinsam Ihre Vision
            verwirklichen.
          </p>
        </div>
            ...
            <div className="glass-card p-8 hover-lift border border-primary/20 relative overflow-hidden">
              ...
              <div className="relative z-10 text-center">
                ...
                <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
                  Holen Sie sich mit unserem Eventplaner direkt ein konkretes
                  Angebot ein. Schnell, unkompliziert und maßgeschneidert für
                  Ihre Bedürfnisse.
                </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-body text-muted-foreground mb-8">
                Erzählen Sie uns von Ihrem Vorhaben und wir melden und
              ...
              >
                      ...
                      <FormItem>
                        ...
                        >
                          ...
                          <SelectContent className="bg-card border-border/50">
                            ...
                            <SelectItem value="firmenveranstaltung">
                              Firmenveranstaltung
                            </SelectItem>
                            ...
                            <SelectItem value="abschlussfeier">
                              Abschlussfeier
                            </SelectItem>
                            <SelectItem value="abiball">Abiball</SelectItem>
                            <SelectItem value="produktpräsentation">
                              Produktpräsentation
                            </SelectItem>
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        >
                          ...
                          <SelectContent className="bg-card border-border/50">
                            <SelectItem value="morgens">
                              Morgens (08:00 - 12:00 Uhr)
                            </SelectItem>
                            <SelectItem value="mittags">
                              Mittags (12:00 - 15:00 Uhr)
                            </SelectItem>
                            <SelectItem value="nachmittags">
                              Nachmittags (15:00 - 18:00 Uhr)
                            </SelectItem>
                            <SelectItem value="abends">
                              Abends (18:00 - 20:00 Uhr)
                            </SelectItem>
                            <SelectItem value="wochenende">
                              Am Wochenende
                            </SelectItem>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        Veranstaltungsort (falls bereits bekannt)
                      </FormLabel>
                      <FormControl>
                        <Input
          ...
          <div className="space-y-8 flex-col h-full">
            <div>
              ...
              <p className="text-body text-muted-foreground mb-8">
                Sie erreichen uns unkompliziert über Ihren bevorzugten
                Kommunikationsweg.
              </p>
            </div>
            ...
            <div className="glass-card p-8 text-center hover-lift relative overflow-hidden border border-border/20">
              ...
              <div className="relative z-10">
                ...
                <p className="text-muted-foreground mb-8 max-w-lg mx-auto">
                  Speichern Sie unsere Kontaktdaten direkt oder nutzen Sie den
                  QR-Code für sofortigen Zugriff
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center mb-6">
                  ...
                  <div className="flex flex-col items-center">
                    <a
                      ...
                      onClick={() =>
                        trackEvent("click", "download", "contact_vcard")
                      }
                    >
                      <Button
                        size="lg"
